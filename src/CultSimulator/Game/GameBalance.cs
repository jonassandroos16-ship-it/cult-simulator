...
public static class GameBalance
{
    ...
    public const double FollowerFaithPerSec = 0.08;
    public const double FollowerGoldPerSec = 0.03;
    public const double ShrineFaithPerSec = 0.5;
    public const double CathedralGoldPerSec = 0.35;
    public const double MonolithFaithBonus = 0.12;
    public const double TreasuryGoldBonus = 0.12;
    public const double ObservatoryFaithBonus = 0.09;
    public const double ReliquaryGoldBonus = 0.09;
    ...
    public const double PreachFollowerScaling = 0.006;
    ...
    public const double CovenTakeoverFaithPercent = 0.3;
    public const double CovenTakeoverGoldPercent = 0.3;
