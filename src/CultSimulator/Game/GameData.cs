...
public static class GameData
{
    public static readonly ImmutableArray<BuildingDef> Buildings = ImmutableArray.Create(
        ...
        new BuildingDef(BuildingType.ShadowGuild, "Shadow Guild", "🗡️", 2000, ResourceKind.Gold, 1.25, "+15% agent generation speed"),
    ...
    public static readonly ImmutableArray<UpgradeDef> Upgrades = ImmutableArray.Create(
        ...
        new UpgradeId.OffshoreAccounts, "Shadow Ledger", "📓", 2000, 6000, 15, "Bank idle cap ×1.5", 30),
        new UpgradeId.DarkLedger, "Blood Pact", "🩸", 5000, 20000, 40, "Bank idle cap ×2", 60),
        new UpgradeId.SoulEndowment, "Eternal Reserves", "💀", 15000, 60000, 100, "Bank idle cap ×2", 120));
    ...
    public static readonly ImmutableArray<BuildingType> ShadowWarBuildings = ImmutableArray.Create(
        BuildingType.ShadowGuild,
