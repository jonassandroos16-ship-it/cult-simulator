...
public static class OccultBalance
{
    ...
    public const double AcolyteArmyPowerPerSec = 0.02;
    ...
    public const int SacrificeFaithBase = 10;
    ...
    // Shadow War — Agent currency and recruitment
    public const double AgentBasePerSec = 0.5;
    public const double AgentCostBase = 10.0;
    public const double AgentCostGrowth = 1.08;
    public const int MaxAgentsPerType = 50;
}
